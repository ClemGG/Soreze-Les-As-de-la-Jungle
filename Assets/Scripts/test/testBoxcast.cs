...
public class testBoxcast : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        xAxis = Input.GetAxis("Horizontal") * m_Speed;
    ...
    void FixedUpdate()
    {
        ...
        m_HitDetect = Physics.BoxCast(transform.position, halfExtents, transform.forward, out m_Hit, transform.rotation, m_MaxDistance);
        if (m_HitDetect)
        {
    ...
    void OnDrawGizmos()
    {
        ...
        if (m_HitDetect)
        {
            ...
            Gizmos.DrawWireCube(transform.position + transform.forward * m_Hit.distance, halfExtents);
        }
        ...
        else
        {
            ...
            Gizmos.DrawWireCube(transform.position + transform.forward * m_MaxDistance, halfExtents);
        }
    }
